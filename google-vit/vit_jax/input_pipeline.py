...
CIFAR host, this module downloads and parses the CIFAR-10 python pickles
directly with the standard library. Images are scaled to the ``[-1, 1]`` range,
matching the preprocessing used upstream.
"""
...
_CACHE_DIR = os.path.join(os.path.expanduser('~'), '.keras', 'datasets')
